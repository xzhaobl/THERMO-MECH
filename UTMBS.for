...
C 第一次应力计算     
      ...
      FGMOD1=FKMOD1*3.0*(1-2.0*FU)/2.0/(1+FU) !G
...
C
      DIMENSION STATEV(NSTATV),COORDS(NCRDS)
       STATEV(1)=0.62 ! OCR=1 Zhou(2015) itatic Clay
	 !STATEV(1)=1.09! OCR=1 Zhou(2017)
       ...
       !STATEV(1)=0.49 ! OCR=2 Zhou(2015)
       STATEV(2)=150 !OCR=1
       !STATEV(2)=225 !OCR=1.5
       !STATEV(2)=300 !OCR=2
       STATEV(3)=20
       !STATEV(4)=100000
      RETURN
